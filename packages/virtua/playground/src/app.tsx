...
export function App() {
  return (
    <Router
      root={(props) => (
        <div class="flex h-screen w-screen flex-col overflow-hidden bg-gray-100">
          ...
          <div class="flex h-[calc(100%-45px)] w-full">
            ...
            <Suspense>
              <div class="b-rd-tl-2xl b b-border h-full w-[calc(100%-185px)] overflow-auto bg-white p-4">
